...
object FipeResultItemCallback : DiffUtil.ItemCallback<FipeResult>() {
    override fun areItemsTheSame(oldItem: FipeResult, newItem: FipeResult): Boolean =
        oldItem.code == newItem.code

    override fun areContentsTheSame(oldItem: FipeResult, newItem: FipeResult): Boolean =
